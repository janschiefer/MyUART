...
yosys -DSYNTHESIS -l yosys.log -p "read_verilog -sv hw/gen/*.v; synth_gowin -top MyTopLevelHW -json build.yosys.json" 
...
nextpnr-himbaechel  --detailed-timing-report --freq 27 --timing-allow-fail --parallel-refine --threads 32 --json build.yosys.json --write build.nextpnr.json --device GW1NR-LV9QN88PC6/I5 --vopt family=GW1N-9C --vopt cst=tangnano9k.cst
